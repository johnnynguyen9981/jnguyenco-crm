...
function buildNotificationHtml(d: Record<string, string>): string {
  ...
  return [
    ...
    "<a href='https://jnguyenco-crm.vercel.app/enquiries' style='display:inline-block;background:#083a4f;color:#fff;font-size:13px;font-weight:600;padding:10px 20px;border-radius:8px;text-decoration:none'>View in CRM</a>",
    "</div>",
    "</div>",
    "</div>",
  ].join("");
