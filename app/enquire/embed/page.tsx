...
const PACKAGES = [
  ...
  { id: "hybrid_mini_session",label: "Hybrid Mini Session",                   price: "$375",    desc: "1.5 hrs · Photo + video reel bundle · 40–60 images + 30-sec reel · Extended option (2.5 hrs, $625) available" },
...
const WEDDING_PACKAGES = new Set(["mini_wedding", "full_day_essential", "full_day_premium", "wedding_photo_only", "wedding_video_only", "hybrid_mini_session"]);
