            ...
            <dl className="grid grid-cols-2 gap-x-6 gap-y-3 text-sm">
              ...
              {booking.venue_name && (
                <div>
                  ...
                  <dd className="font-medium mt-0.5">{booking.venue_name}</dd>
                </div>
              )}
              {booking.venue_address && (
                <div>
                  <dt className="text-gray-400">Venue Address</dt>
                  <dd className="font-medium mt-0.5">{booking.venue_address}</dd>
                </div>
              )}
              {showFinancials && (
                <div>
                    ...
                    <div key={p.id} className="flex items-start justify-between text-sm py-1.5 border-b border-gray-50 last:border-0">
                      <div>
                        <div className="flex items-center gap-1.5">
                          ...
                          {p.status === "PAID" && <SendReceiptButton paymentId={p.id} />}
                        </div>
