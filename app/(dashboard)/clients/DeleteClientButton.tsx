...
export function DeleteClientButton({ clientId, clientName, variant = "icon" }: Props) {
        ...
        >
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-brand-navy">Delete {clientName}?</h3>
                <p className="text-sm text-gray-500 mt-1">
                  This will permanently remove their record. Clients with existing bookings cannot be deleted.
                </p>
              </div>
            </div>
